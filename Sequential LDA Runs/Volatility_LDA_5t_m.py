...
#     gensim.corpora.MmCorpus.serialize(TEMP_PATH + '/%s/%s.mm' % (THEME, THEME), corpus_all)
    ...
    dictionary_all = gensim.corpora.Dictionary.load('/user/ee2472/Volatility.dict')
    corpus_all = gensim.corpora.MmCorpus('/user/ee2472/Volatility.mm')
    ...
    # 6. Save the model
    ldaseq.save('user/ee2474/_LDASeqModel_5_topics_monthly')
